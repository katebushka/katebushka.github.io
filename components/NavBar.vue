...
.dark .menu-mobile-list>li>a:hover {
  color: var(--yellow);
  transition: 500ms;
  text-shadow: 1px 1px 2px var(--color-l-main);
}
.light .menu-list>li>a:hover,
.light .menu-mobile-list>li>a:hover {
  color: var(--yellow);
  transition: 500ms;
  text-shadow: 1px 1px 2px var(--color-main);
}

.light .menu-list>li>a,
.light .menu-mobile-list>li>a {
  color: var(--color-main);
  display: block;
}
.dark .menu-list>li>a,
.dark .menu-mobile-list>li>a {
