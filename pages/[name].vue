<template>
    <div class="padding-up">
        <div class="card-box">
            ...
            <div class="card-text">
                <div><b>front-end</b>: {{ project.css }}, {{ project.js }}</div>
                <div><b>tools</b>: {{ project.tools }}</div>
                <div><b>back-end</b>:</div>
            </div>
        </div>
        <NuxtLink class="card-btn" :to="`/${project.site}`">Look at this</NuxtLink>
    </div>
    <div class="footer">
    <NuxtLink v-if="project.prev" :to="`/${project.prev}`">
    ...
    <NuxtLink v-if="project.next" :to="`/${project.next}`">
