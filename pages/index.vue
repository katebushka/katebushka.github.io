...
<template>
    <div class="bg-blue padding-up padding-down">
        <div class="container">
            ...
            <div class="text bg-about">
                Hi. My name's Kate. I'm learning front-end. I work on pure CSS and Bootstrap and Tailwind frameworks. I
                    ...
                    <div class="project-box">
                      ...
                      <div>
                        <NuxtLink target="_blank" to="#">
                          <img src="~/assets/images/project-chat.png" alt="project-2">
                        </NuxtLink>
                      </div>
                    </div>
                    <div class="project-box">
                      ...
                      <div>
                        <NuxtLink to="#" target="_blank">
                          <img src="~/assets/images/project-3-1.png" alt="project-3">
                        </NuxtLink>
                      </div>
                    </div>
                    <div>
                      ...
                      <div>
                        <NuxtLink target="_blank" to="#">
                          <img src="~/assets/images/hr-project.png" alt="hr-project">
                        </NuxtLink>
                      </div>
                    </div>
                    <div>
                      ...
                      <div>
                        <NuxtLink to="https://booking.emtza.ru/" target="_blank">
                          <img src="~/assets/images/book-project.png" alt="booking-project">
                        </NuxtLink>
                      </div>
                    </div>
                    <div>
                      ...
                      <div>
                        <NuxtLink target="_blank" to="#">
                          <img src="~/assets/images/project-4.png" alt="stat-project">
                        </NuxtLink>
                      </div>
                    </div>
                    <div>
                      ...
                      <div>
                        <NuxtLink target="_blank" to="https://housedes.ru">
                          <img src="~/assets/images/project-estate.png" alt="estate-project">
                        </NuxtLink>
                      </div>
                    </div>
                    <div>
                        ...
                        <div>
                          <NuxtLink target="_blank" to="#">
                            <img src="~/assets/images/first-porfolio.png" alt="project-2">
                          </NuxtLink>
                        </div>
                      </div>
    ...
    <div class="bg-blue padding-up padding-down">
        <div class="container">
            ...
            <div class="item">
                <NuxtLink to="#" title="telegramm"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                        <path
                ...
                <NuxtLink to="#" title="github"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                        <path
            ...
            <NuxtLink mailto="katerbysh@gmail.com" class="btn-email">
                email me
            </NuxtLink>
